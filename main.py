...
# This part is just for validation purposes.
user_query = "what is the performance management process followed here ?" # "how many sick leaves are there"
...
logger.info(f"retrieved_documents: {retrieved_documents}")
